...
/**
 * Global top bar. Shown on every authenticated page.
 *
 * - Mobile: shows the brand lockup on the left (sidebar is hidden).
 * - Desktop: brand lives in the sidebar; left side is empty.
 *
 * Always shows the notification bell + avatar menu on the right.
 * The avatar menu also surfaces Message and Admin on mobile, where the
 * bottom bar can only carry 5 items per Doc5 §2.3.
 */
    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        ...
        >
          ...
          {/* Mobile: surface Message and (if applicable) Admin here,
              since the bottom bar can't fit them. Hidden on md+. */}
          ...
          {/* Sign out is a server action / form post — never a GET link. */}
